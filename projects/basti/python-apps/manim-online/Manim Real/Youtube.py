from manim import *
class Youtube3(Scene):
    def construct(self):
        text = Text("Wie viele Transformationen sind das?")
        ...
        star = Star(color=YELLOW, fill_opacity=0.4, fill_color=YELLOW)
        square = Square()
        ...
        pentagram = Star(color=RED, fill_opacity=0.4, fill_color=RED)
