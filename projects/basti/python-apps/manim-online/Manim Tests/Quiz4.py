...
class Quiz4(Scene):
    def construct(self):
        ...
        # Neuer Updater, der den Text immer in die Mitte des Kreises verschiebt
        ...
        # Der Updater sorgt dafür, dass der Timer-Text immer im Kreis bleibt
        ...
        self.play(ReplacementTransform(question1, question2), ReplacementTransform(answers1, answers2),
                  timer_circle.animate.move_to(answers2.get_left() + LEFT * 2))
        start_timer()
        self.wait(16)
        stop_timer()
        ...
        self.play(ReplacementTransform(question2, question3), ReplacementTransform(answers2, answers3),
                  timer_circle.animate.move_to(answers3.get_left() + LEFT * 2))
        start_timer()
        self.wait(16)
        stop_timer()
        ...
        self.play(ReplacementTransform(question3, question4), ReplacementTransform(answers3, answers4),
                  timer_circle.animate.move_to(answers4.get_left() + LEFT * 2))
        start_timer()
        self.wait(16)
        stop_timer()
        ...
        self.play(ReplacementTransform(question4, question5), ReplacementTransform(answers4, answers5),
                  timer_circle.animate.move_to(answers5.get_left() + LEFT * 2))
        start_timer()
        self.wait(16)
        stop_timer()
        ...
        self.play(ReplacementTransform(question5, question6), ReplacementTransform(answers5, answers6),
                  timer_circle.animate.move_to(answers6.get_left() + LEFT * 2))
        start_timer()
        self.wait(16)
        stop_timer()
        ...
        self.play(ReplacementTransform(question6, question7), ReplacementTransform(answers6, answers7),
                  timer_circle.animate.move_to(answers7.get_left() + LEFT * 2))
        start_timer()
        self.wait(16)
        stop_timer()
        ...
        self.play(ReplacementTransform(question7, question8), ReplacementTransform(answers7, answers8),
                  timer_circle.animate.move_to(answers8.get_left() + LEFT * 2))
        start_timer()
        self.wait(16)
        stop_timer()
